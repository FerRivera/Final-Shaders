...
public class DirectionalPathFXManager : MonoBehaviour
{
	...
	void LateUpdate ()
    {
        ...
        _camera.SetReplacementShader(detectiveModeShader, "DirectionalPath");
    ...
    void OnRenderImage(RenderTexture src, RenderTexture dst)
    {
        if (_glowMapPass)
        {
            ...
            postEffectMaterial.SetTexture("DirectionalPathMap", _temporaryRenderTexture);
